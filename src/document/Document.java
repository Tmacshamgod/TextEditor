...
public abstract class Document {
	...
	protected int countSyllables(String word)
	{
		...
		char[] charArrays = word.toLowerCase().toCharArray();
		for(int i = 0; i < charArrays.length; i++) {
			if((i == (charArrays.length - 1)) && charArrays[i] == 'e'
					&& newSyllable && count > 0) {
				break;
			}
			if(vowels.contains(charArrays[i]) && newSyllable) {
				count++;
				newSyllable = false;
			} else if(!vowels.contains(charArrays[i])) {
				newSyllable = true;
			}
		}
		return count;
...
//				if(charArrays[i] == 'e') {
//					if(vowels.contains(charArrays[i - 1]) || count == 0) {
//						count++;
//					}
//				}
//				else if(vowels.contains(charArrays[i])) {
...
//				break;
//			}
//			if(vowels.contains(charArrays[i]) && !vowels.contains(charArrays[i + 1])) {
//				count++;
//			}
//		}
//		return count;
